...
export const Contacts = () => {
    return (
        <>
            ...
            <HStack paddingTop={5} paddingBottom={28} spacing={3} align={'center'}>
                <Image src={`${process.env.PUBLIC_URL}/images/logo/ht-logo.svg`} alt="ht-logo" h="16" />
                <Text textStyle={'body'} whiteSpace={{ base: 'normal', md: 'nowrap' }}>
                    {'Neotaku Jewelry is a master thesis project created by'}
                    <Text as="span" textStyle={'bodyHighlight'} whiteSpace={{ base: 'normal', md: 'nowrap' }}>
                        {' Hana\u00A0Tokárová'}.
                    </Text>
                </Text>
            </HStack>
